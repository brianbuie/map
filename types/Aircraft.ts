 ...
 *
 * [local adsb server]/data/aircraft.json
...
export type Aircraft = {
  ...
  dbFlags?: number; // 1: military, 2: interesting, 3: PIA, 4: LADD
...
export type AircraftFeature = GeoJSON.Feature<GeoJSON.Point, Aircraft>;

export type AircraftFeatureCollection = GeoJSON.FeatureCollection<GeoJSON.Point, Aircraft>;
